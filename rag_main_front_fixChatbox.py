...
#            message(query, is_user=True, key=f"user_{len(st.session_state.past)}")
            ...
            # 记录并显示AI响应
                ...
                with st.spinner(f'I think this is a {selected_problem} Problem. Let me analyze...'):
                    ...
                    if selected_problem == "Network Revenue Management":
                        ...
                        information = pd.read_csv('./Large_Scale_Or_Files/NRM_example/nike Shoes Sales.csv')
        ...
        #                    print(data)
                        ...
                        informationC = pd.read_csv('./Large_Scale_Or_Files/RA_example/capacity.csv')
                        informationP = pd.read_csv('./Large_Scale_Or_Files/RA_example/products.csv')
                        information = []
                        ...
                        with open('./Large_Scale_Or_Files/RA_example/sony.txt', 'r', encoding='utf-8') as file:
                            label = file.read()
                        ...
                        few_shot_examples = f"""
                                ...
                                Question: Based on the following transportation problem description and data, please formulate a complete linear programming model using real data from retrieval. {example_data_description}
